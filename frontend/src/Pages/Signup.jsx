...
const Signup = () => {
    ...
    return (
        <div className="min-w-screen min-h-screen bg-linear-120 from-10% from-auth-left via-30% via-auth-right to-auth-left overflow-hidden">
            <div className="absolute top-0 left-0 max-500w:hidden w-screen min-h-fit  flex justify-start z-1">
            ...
            <div className="w-screen h-screen flex justify-center items-center">
                <div className="bg-white1 backdrop-blur-[40px] rounded-[10px] p-[40px] max-500w:p-[27px] max-400w:p-[18px] max-330w:p-[12px] border-1 border-white/20 shadow-auth">
                    <form className="flex flex-col w-[470px] max-700w:w-[430px] max-600w:w-[370px] max-500w:w-[335px] max-400w:w-[280px] max-330w:w-[220px] z-2">
                        <label for="username" className="text-white font-semibold text-[17.5px] w-fit h-fit justify-self-start mb-2 cursor-pointer z-10 pointer-events-auto">UserName : </label>
                        ...
                        <label for="emailid" className="text-white font-semibold text-[17.5px] w-fit h-fit justify-self-start mb-2 cursor-pointer z-10 pointer-events-auto">Email-Id : </label>
                        ...
                        <label for="password" className="text-white font-semibold text-[17.5px] w-fit h-fit justify-self-start mb-2 cursor-pointer z-10 pointer-events-auto">Password : </label>
                    ...
                    <div className="absolute top-0 flex w-full h-fit justify-end z-0 pointer-events-none">
                    ...
                    <div className="absolute -bottom-8 flex justify-center w-full h-fit z-0 pointer-events-none">
